...
from sim.mahasiswa.forms import mahasiswaF, loginmahasiswaF, editmahasiswaF, pengaduanF,editpengaduanF
...
def data_mhs():
    ...
    if form.validate_on_submit():
        ...
        add_mahasiswa=Tmahasiswa(npm=form.npm.data, nama=form.nama.data, 
        email=form.email.data, password=pass_hash, kelas=form.kelas.data, 
